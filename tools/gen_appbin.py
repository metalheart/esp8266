...
cmd = 'cp ../../../../../tools/genflashbin%s.exe .'%(ver)
os.system(cmd)

cmd = 'genflashbin%s.exe eagle.app.%s.text.bin '%(ver, ver)+entry_addr+' eagle.app.%s.data.bin '%(ver)+ \
                     data_start_addr+' eagle.app.%s.rodata.bin '%(ver)+rodata_start_addr
